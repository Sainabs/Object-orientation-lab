...
//Code Here--//just storying value,holding value
const {color:newColor,make:newMake,model:newModel,year:newYear}= carDetails

//////////////////////////// PROBLEM 7 ////////////////////////////
//try adding the values of the properties
/*
...
console.log(greeting(obj))
 ...
 //pulling data out, deconstruction
//const {firstName:Harry,lastName:Potter, title:student} = obj
...
//Code Here
delete user.age
//console.log(age)///will output age not defined
...
let pet= new Cats("Luna", 6, "Orange")
...
let spell= new Wizard('aladin', 20, 'apracadabra')
...
//Code Here
let firstPhone =new Phone('iphone','thirteen',164,'gold',1300);
let secondPhone =new Phone('sumsung','galaxy',120,'black',1100);
let thirdPhone =new Phone('motorola','three',84,'gold',300)
...
/*
  ...
  Challenge yourself by going online and 
...
const colorsCopy ={
...colors,
  // background: 'red',  //can be uncommemted, will output correct output
  // highlight: 'blue',
  // text: 'yellow'
};
...
/*
  ...
  and require these 3 parameters: capacity (how many passengers),
   color, and mileage.
...
class Vehicle{
  ...
  move (miles){
    this.mileage += miles //this.millage=millage+miles
    console.log(this.mileage)
  }
}


//let miles=move.mileage (25)
// console.log(miles)
...
//Code Here
const myFirstVehicle= new Vehicle (5, 'gold',3000);
...
//Code Here 
const myFirstMotorcycle= new Motorcycle (2, 'black',5000,'harley', 'isCool');
/*
...
//Code Here
const myFirstBoat = new Boat(4,'white', 50,'waterWasher','seaBoat', false);
